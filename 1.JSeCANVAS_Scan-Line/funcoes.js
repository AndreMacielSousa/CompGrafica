...
function LeftEdgeScan(xa,ya,xg,yg){

    var x = xa;                     operacoes+="x= "+xa+"<br/>";
    var numerador = xg - xa;        operacoes+="numerador= "+xg+" - "+xa+" = "+numerador+"<br/>";
    var denominador = yg - ya;      operacoes+="denuminador= "+yg+" - "+ya+" = "+denominador+"<br/>";
    var incremento = numerador;     operacoes+="incremento= "+incremento+"<br/>";

    for(var y = ya; y<=yg;y++){
                                    operacoes+="drawpixel"+x+" "+y+" <br/><br/>";
        drawPixel(x,y);
        incremento += numerador;    operacoes+="incrmento+= "+numerador+" = "+incremento+"<br/>";
        if (incremento > denominador){
                                    operacoes+="incremento > denominador"+incremento+" > "+denominador+"<br/>";
            x++;                    operacoes+="x++ ->"+x+"<br/>";
            incremento-=denominador;operacoes+="incremento-=denominador ->"+incremento+"<br/>";
        }
    }
